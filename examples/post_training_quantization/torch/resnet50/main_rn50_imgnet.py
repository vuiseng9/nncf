...
dataset_path = "/data1/dataset/ilsvrc2012/torchvision/"
# download_dataset()
...
model.eval()
# model = load_checkpoint(model) # torchvision has pretrained imagenet weights
