...
from nncf.torch.sparsity.movement.loss import SparseLoss, SparseLossForPerLayerSparsity
...
class MovementSparsityController(BaseSparsityAlgoController):
    ...
    # @property
    # def loss(self):
    #     return self.scheduler._current_regu_lambda * self._loss
    ...
    def statistics(self, quickly_collected_only=False) -> NNCFStatistics:
        ...
        stats = MovementSparsityStatistics(model_statistics,
                                           self.scheduler._current_importance_threshold,
                                           self.scheduler._current_regu_lambda)
